        ...
        if not api_key: st.error("API 키 필요")
            ...
            with chat_container.chat_message("assistant"):
                ...
                try:
                    ...
                    ctx = f"종목:{t_data['종목명']}, 재무:[현재가:{t_data['현재가']}, PER:{t_data['PER']} 시장, 동종 업계 평균과 비교해줘, ROE:{t_data['ROE']} 시장, 동종 업계 평균과 비교해줘, 부채:최근 자료 검색해서 확인 해줘]. 기술적분석:{tech_info}. 질문:{prompt}. 한국어 답변."
